const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=ce4a7567162ee2c718a59cbec4e90ea5&units=imperial';
...
const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=ce4a7567162ee2c718a59cbec4e90ea5&units=imperial';
fetch(apiURL2)
    .then((response) => response.json())
    .then((jsObject) => {
